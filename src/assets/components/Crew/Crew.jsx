                        ...
                        <SwiperSlide>
                            <div className="row crew-row">
                                ...
                                <div className="col-12 col-lg-6 crew-image-container">
                                    <img className='crew-image' src={Crew1} alt="Commander Douglas Hurley" />
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="row crew-row">
                                ...
                                <div className="col-12 col-lg-6 crew-image-container">
                                    <img className='crew-image' src={Crew2} alt="Mission Specialist MARK SHUTTLEWORTH" />
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="row crew-row">
                                ...
                                <div className="col-12 col-lg-6 crew-image-container">
                                    <img className='crew-image' src={Crew3} alt="PILOT Victor Glover" />
                                </div>
                            </div>
                        </SwiperSlide>
                        <SwiperSlide>
                            <div className="row crew-row">
                                ...
                                <div className="col-12 col-lg-6 crew-image-container">
                                    <img className='crew-image' src={Crew4} alt="Flight Engineer Anousheh Ansari" />
                                </div>
                            </div>
                        </SwiperSlide>
